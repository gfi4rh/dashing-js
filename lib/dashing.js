...
module.exports.Dashing = function Dashing() {
    ...
    dashing.addEventRoute = function () {
    ...
    app.get('/events', dashing._protected, dashing.addEventRoute());
    ...
    dashing.start = function () {
        ...
        var server = http.createServer(app).listen(dashing.port);
        ...
        logger.info('Listening on port:' + dashing.port + (process.env.__daemon === 'false' ? ', CTRL+C to stop' : ''));
    };
